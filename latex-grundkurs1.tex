...
%		\end{frame}
		...
		\begin{frame}{Anmerkungen}
			...
			\vspace{0.2cm}
			\slideheading{Anmerkung:} Man kann \href{https://latexbase.com}{latexbase.com} \href{https://www.overleaf.com}{overleaf.com} zum live-mitcoden benutzen.
		\end{frame}
...
\section{Finden von maximalen Cliquen in Graphen}
    ...
    \subsection{NP-Vollständigkeit}
        ...
        \subsubsection{Bedeutung}
			...
			\vspace{0.2cm}\\
			\includegraphics[width=0.725\linewidth]{images/gliederung-beispiel}
		\end{frame}
	...
	\section{Mathematischer Textsatz}
		...
		\begin{frame}[containsverbatim]{Mathe-Umgebung}
			...
			\begin{itemize}
				...
				\begin{itemize}
					\item Mathe innerhalb von Text (stammt nicht aus \LaTeX, sondern aus \TeX{}, weit verbreitet)
				\end{itemize}
				\item Die \texttt{\textbackslash(...\textbackslash)} Umgebung
				\begin{itemize}
					\item Mathe innerhalb von Text (stammt aus \LaTeX\ und funktioniert besser mit den \texttt{ams}-Paketen und z.B. in Überschriften)
				\end{itemize}
				\item Die \texttt{\textbackslash[...\textbackslash]} Umgebung
				\begin{itemize}
