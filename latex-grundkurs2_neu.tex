...
\(v = \SI{50}{\percent} \cdot c\)
(also \(\SIrange{0}{3e8}{\meter\per\second}\))
erhalten wir Energien bis \(\SI{1.4}{\TeV}\)
(\(\si{\tera\eV} = \SI{1.6022e-7}{\J}\)).
			\end{latexcode}
			\slideheading{Ergebnis:}
...
Für Geschwindigkeiten bis zu \(v = \SI{50}{\percent} \cdot c\) (also \(\SIrange{0}{3e8}{\meter\per\second}\)) erhalten wir Energien bis \(\SI{1.4}{\TeV}\) (\(\si{\tera\eV} = \SI{1.6022e-7}{\J}\)).
